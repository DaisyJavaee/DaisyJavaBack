...
public class GroupController {
    ...
    //审核队伍申请
    @RequestMapping(value="/{groupId}/applications/{applicationId}",method=RequestMethod.PATCH)
    public Result updateApplication(@PathVariable int groupId, @PathVariable int applicationId, @RequestBody Application application, HttpServletRequest request)
    {
        return groupService.updateApplication(groupId, applicationId, application, request);
    }
